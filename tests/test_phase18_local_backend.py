...
from engine.intelligence.local_runtime import LocalRuntimeSnapshot
from engine.intelligence.zero_cost_models import FLUX2_KLEIN_4B
...
class LocalBackendTests(unittest.TestCase):
    def runtime(self, *, cuda=True, vram=16.0):
        return LocalRuntimeSnapshot(
            ...
            vram_gb=vram if cuda else None,
        )
    ...
    def test_provenance_preserves_seed_and_request(self):
        provenance = LocalGenerationProvenance(
            ...
            model_id=FLUX2_KLEIN_4B.model_id,
            backend="diffusers",
            seed=712345,
        ...
        self.assertEqual(data["model"], FLUX2_KLEIN_4B.model_id)
