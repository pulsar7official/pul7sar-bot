...
class GoldenVisualBatchTests(unittest.TestCase):
    def test_batch_builds_unique_integrity_locked_handoffs(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(manifest["visual_grammar_surface_visibility"], "partial_deterministic")
            ...
            for item in manifest["candidates"]:
                ...
                self.assertEqual(item["visual_grammar_surface_visibility"], "partial_deterministic")
    ...
    def test_manifest_is_written_and_matches_returned_structure(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(saved["visual_grammar_surface_visibility"], "partial_deterministic")
