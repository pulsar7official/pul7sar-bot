...
class Phase18FirstGoldenReviewWorkflowTests(unittest.TestCase):
    ...
    def test_replays_runtime_fingerprint_before_bootstrap_host_and_review_png_evidence(self):
        ...
        bootstrap_index = self.text.index("pul7sar-first-golden-colab-bootstrap-v4")
