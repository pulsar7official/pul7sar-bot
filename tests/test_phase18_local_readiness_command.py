...
class LocalReadinessCommandTests(unittest.TestCase):
    def test_command_exists_and_declares_no_install_download_or_paid_api(self):
        ...
        self.assertIn('"golden_reference_dtype": "bfloat16"', text)
        self.assertIn('"engineering_preview_dtype": "float16"', text)
        self.assertIn('"preview_may_claim_golden": False', text)
        ...
        self.assertIn('"requested": args.dtype', text)
