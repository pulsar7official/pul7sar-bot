...
TARGETED_TEST_MODULES = (
    ...
    "tests.test_phase18_story_visual_scenario_matrix",
    "tests.test_phase18_editorial_angle_selector",
    "tests.test_phase18_editorial_planning_service",
    "tests.test_phase18_editorial_copy_builder",
    "tests.test_phase18_story_event_resolver",
    "tests.test_phase18_scene_complexity_policy",
    "tests.test_phase18_sport_visual_rules",
    "tests.test_phase18_sports_fact_schema",
    "tests.test_phase18_fact_locked_editorial_adapter",
    "tests.test_phase18_hybrid_layer_planner",
    "tests.test_phase18_visual_layer_qa",
    "tests.test_phase18_hybrid_visual_quality_gate",
    "tests.test_phase18_geometry_capabilities",
    "tests.test_phase18_editorial_visual_authorization",
    "tests.test_phase18_full_event_sport_matrix",
