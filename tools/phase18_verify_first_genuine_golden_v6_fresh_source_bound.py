#!/usr/bin/env python3
"""Bind freshness + source provenance + PNG bytes for First Genuine Golden v6.
...
MANIFEST_SCHEMA = "pul7sar-phase18-first-genuine-golden-v6-fresh-source-bound-manifest-v1"
...
def build_manifest(
    *,
    ...
    return {
        ...
        "status": "FIRST_GENUINE_GOLDEN_V6_FRESH_SOURCE_BOUND_EVIDENCE_VERIFIED",
